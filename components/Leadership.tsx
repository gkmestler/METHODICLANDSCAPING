...
export default function Leadership() {
  ...
  const teamMembers = [
    ...
    { name: 'Logan Mestler', role: 'Managing Partner and Co-Founder', image: '/images/LoganOlder1.png', bio: 'Logan co-founded Methodic Landscaping alongside his brother Gavin with a mission to preserve and modernize the businesses that America runs on.', imageStyle: { transform: 'scale(1.3) translateY(15%)' }, linkedin: 'https://www.linkedin.com/in/logan-mestler-753917253/', brightness: 1.28, blur: 0.25 },
